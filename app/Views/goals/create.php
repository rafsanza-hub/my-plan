...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Goal /</span> Tambah Goal</h4>

        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Tambah Goal</h5>
            </div>
            <div class="card-body">
                ...
                <form action="<?= site_url('goal/save') ?>" method="post">
                    <?= csrf_field() ?>
